            ...
            new
            {
                ...
                reviews = JsonSerializer.Deserialize<resultContainer>((await client.GetAsync(new RestRequest())).Content).result.reviews.Concat(
                    new[]
                    {
                        ...
                        new review("I couldn’t be happier with the service! The movers were efficient, professional, and took great care with all my belongings. Everything arrived in perfect condition, and they made sure everything was placed exactly where I wanted in my new home.", "Ali Baranpourian")
                    }
                )
            }
        ));
